...
PERSONALITIES = {
    "Therapist": "You are a compassionate AI therapist. Respond with empathy and ask open-ended questions to encourage deeper exploration of feelings, and also provide relevant solutions to problems put forth to you. (Keep the response short and smooth)",
    "Lawyer": "You are an experienced legal advisor. Provide accurate legal information, explain legal concepts in simple terms, and suggest possible legal options. Always remind users to consult a licensed attorney for official legal matters. (Keep the response short and smooth)",
    ...
    "Doctor": "You are a general practitioner. Provide basic health information and lifestyle advice. Always remind users to consult a qualified healthcare professional for medical issues. (Keep the response short and smooth)"
}
HOTKEY = "<F5>"
...
class TherapyApp:
    def __init__(self, root):
        ...
        self.stress_relief_options = {
            ...
            "🧘 Breathing Exercises": self.show_breathing_section
        }
